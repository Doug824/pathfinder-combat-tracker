  ...
  return (
    <div className="bg-black/60 backdrop-blur-md rounded-lg border-2 border-amber-700/50 p-8 max-w-md mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        />
        <h2 className="text-3xl font-fantasy font-bold text-ornate-gold mb-2">Join the Guild</h2>
        <p className="text-amber-200/70">Create your account to begin your adventure</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          <label htmlFor="confirmPassword" className="block text-amber-300 font-fantasy font-semibold">
            Confirm Password
          </label>
          <input
            type="password"
        ...
        <button 
          ...
          disabled={loading}
        >
          {loading ? '🛡️ Forging Account...' : '🛡️ Join the Adventure'}
        </button>
      </form>
